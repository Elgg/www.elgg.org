...
<div id="content_wrapper">
	<div class="content"><!-- open content -->
		...
		<div id="page_contents">
			...
			<div class="award"><p>
				<a href="https://github.com/Elgg/Elgg/blob/master/CONTRIBUTING.md"><img src="images/bugs.gif" alt="Documentation" align="left" style="margin-right:10px;" width="60px" /></a>
			...
			<div class="award"><p>
				<a href="https://community.elgg.org/groups/profile/211069/feedback-and-planning"><img src="images/mailing.gif" alt="Documentation" align="left" style="margin-right:10px;" width="60px" /></a>
				<b>Feedback and Planning</b><br />Discussions about the past, present, and future of Elgg.</p>
				<div style="clear:both;"></div>
			</div>
			<div class="award"><p>
				<a href="http://reference.elgg.org/1.9/"><img src="images/api_reference.gif" alt="Documentation" align="left" style="margin-right:10px;" width="60px" /></a>
