...
<div id="content_wrapper">
	<div class="content"><!-- open content -->
		...
		<div id="page_contents">
			<h1 class="header_color">Latest release - October 14, 2010</h1>
			...
			<p class="leader">Elgg v1.7.4 includes important bugfixes.<br />
			It is the recommended release.</p>
			<div id="download_btn">
				<p><a href="http://elgg.org/getelgg.php?forward=elgg-1.7.4.zip" class="download">Download Elgg 1.7.4</a></p>
			</div><br /><br />
<!--			<h1 class="header_color" style="margin-top:40px;">Latest Beta</h1>
			<p class="leader">Elgg v1.7.4 beta.<br />
			Please report all bugs to <a href="http://trac.elgg.org">trac</a>.
			Do not use on a production server!
			</p>
			<div id="download_btn">
				<p><a href="http://elgg.org/getelgg.php?forward=elgg-1.7.4b.zip" class="download">Grab 1.7.4 beta</a></p>
			</div>
-->
		...
		<div id="mid_right">
			<h1>Subversion Access</h1>
				<p>If you're a developer and want the latest code, using Subversion, you can grab the latest work in progress:</p>
				<p>svn://code.elgg.org/elgg/trunk</p>
				<br />
				<h1>Nightly build</h1>
