...
<div id="sidebar_menu" data-selector="#globalheader a[href=&quot;./about.php&quot;]">
	<?php include '_includes/about-menu-ul.php'; ?>

	<div class="sidebar_box">
		<h2>Money raised</h2>
		<p>All funds raised via the Elgg supporters network go directly into core Elgg development and infrastructure
			provision (elgg.org/svn/trac etc).</p>
		<p>It is a great way to help with Elgg development!</p>
		<p>Supporters are able to put this official logo on their site if they wish:</p>
		<p><img src="images/elgg-supporters.gif" alt="Elgg Supporters" width="185px"/></p>
		<h2>Disclaimer*</h2>
		<p>We operate a no refund policy on supporter subscriptions. If you would like to withdraw your support, go to
			PayPal and cancel your subscription. You will not be billed the following year.</p>
		<p>Being an Elgg Supporter does not give an individual or organization the right to impersonate, trade as or
...
<div id="page_contents">
	<h1 data-title class="header_color">Elgg Supporters</h1>
	<div style="float:right;width:250px;margin:30px 20px;text-align:center;">
		<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
			...
			<table>
				...
				<tr>
					<td><select name="os0">
							<option value="Individual">Individual : $50.00USD - yearly</option>
							<option value="Organization">Organization : $150.00USD - yearly</option>
						</select></td>
				</tr>
			</table>
			<input type="hidden" name="currency_code" value="USD">
			<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribe_LG.gif" border="0"
				   name="submit" alt="PayPal - The safer, easier way to pay online!">
			<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
		</form>
	</div>
	<p><span><br/>
				Are you an individual or organization who uses and likes Elgg? Consider becoming an official supporter of the Elgg project. With only $50 per year for individuals or $150 per year for organizations, you can help the Elgg project.<br/>
				</span></p>
	<p><span>Elgg supporters are listed below unless requested not to be. If you would like to become an Elgg supporter, please read the disclaimer to the left, subscribe via PayPal, and send an email to <a
				href="mailto:info@elgg.org">info@elgg.org</a> confirming the date you subscribed and the relevant details for your level (these can be found on the tables below). Once all the details have been received, we will add you to the appropriate list. Thanks for your support!
	</p>
