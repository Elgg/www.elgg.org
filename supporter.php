...
<div id="globalheader_wrapper">
	...
	<ul>
		...
		<li><a href="about.php" class="header selected">About</a></li>
	...
	<div class="content">
		<div id="sidebar_menu">
				<div class="sidebar_box">
					<h2>Money raised</h2>
					<p>All funds raised via the Elgg supporters network go directly into core Elgg development and infrastructure provision (elgg.org/svn/trac etc).</p>
					...
					<h2>Disclaimer*</h2>
					<p>We operate a no refund policy on supporter subscriptions. If you would like to withdraw your support, go to PayPal and cancel your subscription. You will not be billed the following year.</p>
					...
					<p><small>If there is no obvious use of Elgg, your site will be linked to with "nofollow" set.</small></p>
				</div>
		</div>
		<div id="page_contents">
				<h1 class="header_color">Elgg Supporters</h1>
				...
				<table>
					...
					<tr>
						...
						<td><a href="http://community.elgg.org/pg/profile/fabcol">Visit</a></td>
					</tr>
					<tr>
						<td>Paul Stewart</td>
					...
					<tr>
						...
						<td><a href="http://community.elgg.org/pg/profile/jdalsem">Visit</a></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><a href="http://community.elgg.org/pg/profile/topdog08">Visit</a></td>
					</tr>
					<tr>
						<td>Andrew Boon</td>
				...
				<table>
					...
					<tr>
						...
						<td><a href="http://community.elgg.org/pg/profile/gillie">Visit</a></td>
					</tr>
					<tr>
						<td>Dhrup Chand</td>
						<td><a href="http://FKKids.Com">FKKids.Com</a></td>
						<td><a href="http://community.elgg.org/pg/profile/Dhrup2000">Visit</a></td>
					</tr>
					<tr>
