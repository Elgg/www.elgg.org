	...
	<div class="content"><!-- open content -->
		<div id="sidebar_menu">
			<ul>
				...
				<li><a href="involved.php" class="aboutmenu selected">Getting Involved</a></li>
			</ul>
		</div>
		<div id="page_contents">
			...
			<p class="leader">The Elgg <a href="activity" class="accent_color">community pages</a> are a great place to start.</p>
			</div>
