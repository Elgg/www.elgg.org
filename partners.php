...
<div id="globalheader_wrapper">
	...
	<ul>
		...
		<li><a href="services.php" class="header selected" target="_top">Services</a></li>
...
<div id="content_wrapper">
	<div class="content">
		...
		<div id="page_contents">
				<h1 class="header_color">Elgg Partners</h1>
				<p class="leader"><span>
				...
				<div class="partners"> 
					<h2 class="subhead">Colombia - Nivel Siete</h2> 
				<p style="margin-top:10px;"><img src="http://elgg.com/images/partners/nivel.gif" alt="Nivel" align="left" style="margin:0 26px 50px 10px;"/> 
