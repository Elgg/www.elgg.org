	...
	<div class="content">
		<div id="sidebar_menu">
				<div class="sidebar_box">
					...
					<p>If you represent a company providing Elgg services and would like to be listed, and in turn help with core development, <a href="mailto:dave@elgg.com">please get in touch</a> <small>(dave@elgg.com)</small>. At this time, we can only use PayPal, so payment for a listing will come via a PayPal invoice.</p>
