	...
	<div class="content"><!-- open content -->
		<div id="sidebar_menu">
			<ul>
				...
				<li><a href="powering.php" class="aboutmenu selected">Powered by Elgg</a></li>
		...
		<div id="page_contents">
			<h1 class="header_color">Elgg powers networks for a wide range of organizations including the following:</h1>
			<div style="margin-top:20px;">
			<ul>
				<li>Oxfam</li>
				<li>Royal College of British Architects</li>
				<li>Australian Government</li>
				<li>British Government</li>
				<li>Federal Canadian Government</li>
				<li>MITRE</li>
				<li>New Zealand Ministry of Education</li>
				<li>State of Ohio, USA</li>
				<li>The World Bank</li>
				<li>UNESCO</li>
				<li>United Nations Development Programme</li>
				<li>Canadian Employment and Immigration Union</li>
				<li>Tides Canada</li>
				<li>Aerospace</li>
				<li>NASA</li>
				<li>The Executive Lounge</li>
				<li>Hedgehogs.net</li>
				<li>Hill and Knowlton</li>
				<li>Institute of Executive Coaching</li>
				<li>Interactive Games & Entertainment Association</li>
				<li>Live Out There</li>
				<li>UnltdWorld</li>
				<li>Wiley Publishing</li>
				<li>Harvard University Extension School</li>
				<li>Saugus School District</li>
				<li>Stanford University</li>
				<li>Think Global School</li>
				<li>University of Brighton</li>
				<li>University of Calgary, Grid Research Centre</li>
				<li>Universite Lille 1</li>
